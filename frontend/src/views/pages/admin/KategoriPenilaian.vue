    ...
    <div class="card border-slate-200 border pt-4">
        <div class="flex justify-between">
            <div class="flex flex-column justify-center items-center">
                <h3 class="text-2xl font-bold">Kategori Penilaian</h3>
            </div>
        ...
        <DataTable ref="dt" :value="daftarKateogri" dataKey="santri.id" :filters="filters" showGridlines>
